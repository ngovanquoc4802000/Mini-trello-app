       ...
       <div className="flex justify-center mb-6">
        ...
        <div>
          ...
          <input
            ...
            required
            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-50 focus:outline-none sm:text-sm"
          />
        </div>
        <div>
          <label
          ...
          <input
            ...
            placeholder="Nhập mã bạn đã nhận được"
            required
        ...
        <p
          id="errorMessageVerify"
          className="text-red-500 text-sm mt-2 text-center hidden"
        >
