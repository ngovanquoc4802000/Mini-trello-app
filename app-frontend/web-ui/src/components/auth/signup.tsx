    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form className="space-y-4"> {/* Removed onSubmit */}
          ...
          {/* Message Area - You'd conditionally render this in a real app with logic */}
      ...
      <Link to="/signin">
        ...
        <div className="mt-8 text-center text-xs text-gray-400">
          ...
          <p className="mt-1">This site is protected by reCAPTCHA and the Google <a href="#" className="hover:underline">Privacy Policy</a> and <a href="#" className="hover:underline">Terms of Service</a> apply.</p>
        </div>
      </div>
    </div>
  );
