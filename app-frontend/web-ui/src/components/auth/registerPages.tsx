    ...
    return ( 
      ...
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-lg">
        ...
        <div className="space-y-3 mb-6">
          ...
          <button className="w-full cursor-pointer flex items-center justify-center border border-gray-300 rounded py-2 px-4 text-gray-700 hover:bg-gray-50 focus:outline-none focus:shadow-outline">
            <svg
              aria-hidden="true"
              height="16"
              viewBox="0 0 24 24"
