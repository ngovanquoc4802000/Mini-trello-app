...
function TaskDetails({ onClose }: TaskDetailState) {
  return (
    <div className="z-[1000] fixed top-0 left-0 right-0 bottom-0 bg-black/50 min-h-screen bg-black/50 text-white flex items-center justify-centerabsolute  bg-black/70 min-h-screen  text-white p-4 sm:p-6 md:p-8 flex items-center justify-center">
